...
import com.capgemini.bankapp.config.BankAccountJavaConfig;
...
public class BankAccountClient {
	...
	public static void main(String[] args) {
		...
		ApplicationContext context = new AnnotationConfigApplicationContext(BankAccountJavaConfig.class);
